...
```
POST http://222.19.82.136:8000/ocr
...
```
POST http://222.19.82.136/api/Translate
Content-Type: application/json
```
...
| 代理路径 | `/ocr` |
| 上游地址 | `http://222.19.82.136:8000/ocr` |
...
globalData: {
  ...
  // 外网直连（正式环境）
  // ocrApiUrl: 'http://222.19.82.136:8000/ocr',

  // 校园网直连
  // ocrApiUrl: 'http://222.19.82.136:8000/ocr',

  // 翻译 API
  translateApiUrl: 'http://222.19.82.136/api/Translate',
  // 校园网翻译：
  // translateApiUrl: 'http://222.19.82.136/api/Translate',
...
| 外网直连 | `http://222.19.82.136:8000/ocr` |
| 校园网直连 | `http://222.19.82.136:8000/ocr` |
